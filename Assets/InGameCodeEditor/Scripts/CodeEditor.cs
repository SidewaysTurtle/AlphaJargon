...
#pragma warning restore 0649
        ...
        private void UpdateCurrentLineNumbers()
        {
            ...
            if (currentLineCount != lineCount)
            {
                ...
                for (int i = 1; i < currentLineCount + 1; i++) // I don't understand why this would ever need to add 2 lines instead of just adding one like every other code editior out there...
                {
